...
const SYSTEM_PROMPT = `
You are operating in test-driven development mode. Your job is to write failing tests
before writing code — or, for bug fixes, to reproduce the bug with a test before
attempting a fix.
